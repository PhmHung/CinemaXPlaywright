...
test.describe("FULL SUITE: Schedule API Testing ", () => {
  ...
  test("TC_RM02: movieId là số âm (-7)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM03: movieId quá lớn (Integer Overflow)", async ({
    authRequest,
  }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM05: Thiếu trường movieId (Missing)", async ({ authRequest }) => {
  ...
  test("TC_RM07: branchId là số âm (-1)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM08: branchId quá lớn (Overflow)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM09: branchId sai format (Space)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM10: Thiếu trường branchId", async ({ authRequest }) => {
    const params = { ...VALID_DATA };
  ...
  test("TC_RM12: Ngày sai định dạng (dd-mm-yyyy)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM13: Thiếu trường startDate", async ({ authRequest }) => {
    const params = { ...VALID_DATA };
  ...
  test("TC_RM14: Giờ sai logic (25:10)", async ({ authRequest }) => {
    const response = await authRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM15: Thiếu trường startTime", async ({ authRequest }) => {
    const params = { ...VALID_DATA };
  ...
  test("TC_RM16: Không gửi Token (Unauthenticated)", async ({
    publicRequest,
  }) => {
  ...
  test("TC_RM17: Gửi Token rác/Hết hạn", async ({ publicRequest }) => {
    const response = await publicRequest.get(`${BASE_URL}${API_PATH}`, {
  ...
  test("TC_RM20: SQL Injection - Time Based (SLEEP)", async ({
    authRequest,
  }) => {
